...
const ITEM_DEFINITIONS = {
  ...
  night_theme_machine: block({
    ...
    instance_tracked: true,
    block_health: 4,
    texture: "res://Assets/items/special items/theme_machine/night_1.png",
    inventory_icon: "res://Assets/items/special items/theme_machine/night_1.png",
    theme_machine_enabled_frames: [
      "res://Assets/items/special items/theme_machine/night_1.png",
      "res://Assets/items/special items/theme_machine/night_2.png",
    ],
  ...
  snow_theme_machine: block({
    ...
    instance_tracked: true,
    block_health: 4,
    texture: "res://Assets/items/special items/theme_machine/snow_1.png",
    inventory_icon: "res://Assets/items/special items/theme_machine/snow_1.png",
    theme_machine_enabled_frames: [
      "res://Assets/items/special items/theme_machine/snow_1.png",
      "res://Assets/items/special items/theme_machine/snow_2.png",
    ],
    theme_machine_frame_seconds: 0.45,
    seed: "",
    no_collision: true,
