...
Write-Host "== PixelManiaServer: build + commit devil_wings atlas migration (server) ==" -ForegroundColor Cyan
...
$commitMessage = @"
Make devil_wings fully atlas-driven (server mirror)

- Mirror the client's item_database.gd change: devil_wings' texture/inventory_icon and
  idle_frames/jump_frames/fall_frames/flap_frames now reference the wearable atlas frame
  keys (devil_wings_icon, devil_wings_1..5) instead of
  res://Assets/items/back_items/devil_wings_*.png. sprite_folder/idle_sprite dropped,
