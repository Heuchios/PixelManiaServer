...
Write-Host "== PixelManiaServer: build + commit dragon_rusty_wings atlas migration (server) ==" -ForegroundColor Cyan
...
$commitMessage = @"
Make dragon_rusty_wings fully atlas-driven (server mirror)

- Mirror the client's item_database.gd change: dragon_rusty_wings' texture/inventory_icon
  and idle_frames/jump_frames/fall_frames/flap_frames now reference the wearable atlas
  frame keys (dragon_rusty_wings_icon, dragon_rusty_wings_1..5) instead of
  res://Assets/items/back_items/dragon_rusty_wings_*.png. sprite_folder/idle_sprite
  dropped, matching the client entry. Frame ordering unchanged.
"@
