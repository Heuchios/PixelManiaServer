...
function canonicalInstanceKey(worldName) {
...
function createLandfillEventSystem(deps) {
    ...
    entryPenAbovePixels = 128, entryPenBelowPixels = 32, 
    ...
    setLandfillEntryPenBlocks, } = deps;
    ...
    function isLandfillBuildLocked(worldName) {
    ...
    function hasInstance(worldName) {
        return instances.has(canonicalInstanceKey(worldName));
    }
    function deleteInstance(worldName) {
    ...
    function ensureEntryPenForInstance(instance) {
        if (!isPreRaceState(instance.state))
            return;
        ...
        if (!instance.entryPenBounds)
            return;
        if (typeof setLandfillEntryPenBlocks !== "function")
            return;
        try {
