...
Write-Host "== PixelManiaServer: build + commit spiky_wings atlas migration (server) ==" -ForegroundColor Cyan
...
$commitMessage = @"
Make spiky_wings fully atlas-driven (server mirror)

- Mirror the client's item_database.gd change: spiky_wings' texture/inventory_icon and
  idle_frames/jump_frames/fall_frames/flap_frames now reference the wearable atlas frame
  keys (spiky_wings_icon, spiky_wings_1..4) instead of
  res://Assets/items/back_items/spiky_wings_*.png. sprite_folder/idle_sprite dropped,
