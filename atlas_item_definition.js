// Generated from src/atlas_item_definition.ts. Do not edit by hand.
"use strict";
...
const ATLAS_PASSTHROUGH_KEYS = Object.freeze([
    ...
    "atm_machine_block",
    "atm_machine_cooldown_seconds",
    "atm_machine_reward_item_id",
    "atm_machine_reward_item_category",
    "atm_machine_reward_amount_range",
    "atm_machine_ready_atlas_coords",
    "atm_machine_producing_atlas_coords",
    "water_well_block",
...
function buildAtlasItemDefinition(itemId, builders) {
...
module.exports = AtlasItemDefinition;
