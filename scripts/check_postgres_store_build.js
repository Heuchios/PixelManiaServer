...
assert.match(postgresStoreSource, /transaction_overhead_ms/);
assert.match(postgresStoreSource, /session_upsert_ms/);
assert.match(postgresStoreSource, /account_touch_ms/);
assert.match(postgresStoreSource, /session_revoke_ms/);
