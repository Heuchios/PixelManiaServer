...
const { createStore: createStoreWithIdentity } = require("./postgres_test_double.js");
...
/**
 * The double takes the fixture ids explicitly; every call site below predates that, so
 * this keeps `createStore(state)` meaning exactly what it meant before the extraction.
 *
 * @param {any} initialState
 * @returns {{ store: any, fake: any }}
 */
function createStore(initialState) {
  return createStoreWithIdentity(initialState, {
