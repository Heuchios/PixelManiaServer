...
(async () => {
  ...
  assert.match(helperSource, /function runJoinStage/);
  assert.match(helperSource, /\[join\] slow world admission stage/);
  assert.match(helperSource, /join_world_total/);
  assert.match(helperSource, /world_state_refresh/);
  assert.match(helperSource, /player_state_refresh/);
  assert.match(helperSource, /world_state_send/);
